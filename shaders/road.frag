...
layout(std140, binding = 0) uniform buf {
    ...
    float heatShimmer;  // heat haze over the far road, 0..1
...
const vec3 SOIL[12] = vec3[12](
    ...
    vec3(0.2902, 0.1098, 0.1882),
    vec3(0.3216, 0.1255, 0.1882),
    vec3(0.2980, 0.1412, 0.2196),
    vec3(0.2353, 0.0863, 0.2039),
    vec3(0.2000, 0.0902, 0.2039),
    vec3(0.2471, 0.1176, 0.1961),
    vec3(0.4784, 0.2510, 0.2824),
    vec3(0.2353, 0.1020, 0.1804),
...
const vec3 SCRUB[12] = vec3[12](
    ...
    vec3(0.3922, 0.1882, 0.2431),
    vec3(0.4706, 0.2196, 0.2353),
    vec3(0.4196, 0.2275, 0.3216),
    vec3(0.3216, 0.1412, 0.2667),
    vec3(0.1490, 0.0784, 0.1804),
    vec3(0.3412, 0.1882, 0.2510),
    vec3(0.6353, 0.3529, 0.3451),
    vec3(0.3059, 0.1490, 0.2196),
